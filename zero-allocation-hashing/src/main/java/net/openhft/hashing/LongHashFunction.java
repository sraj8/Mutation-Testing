...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 78 + " | " + "trueByteValue = trueByteValue();" + " | " + "LongHashFunction.java" + " | " + " EXPRESSION " + " | " +  " trueByteValue = " + trueByteValue);

            falseByteValue = falseByteValue();
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 79 + " | " + "falseByteValue = falseByteValue();" + " | " + "LongHashFunction.java" + " | " + " EXPRESSION " + " | " +  " falseByteValue = " + falseByteValue);
...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 86 + " | " + "TRUE_BYTE_VALUE = trueByteValue;" + " | " + "LongHashFunction.java" + " | " + " ASSIGNMENT " + " | " +  " private static final byte TRUE_BYTE_VALUE = " + TRUE_BYTE_VALUE);

        FALSE_BYTE_VALUE = falseByteValue;
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 87 + " | " + "FALSE_BYTE_VALUE = falseByteValue;" + " | " + "LongHashFunction.java" + " | " + " ASSIGNMENT " + " | " +  " private static final byte FALSE_BYTE_VALUE = " + FALSE_BYTE_VALUE);
...
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 299 + " | " + "stringHash = UnknownJvmStringHash.INSTANCE;" + " | " + "LongHashFunction.java" + " | " + " ASSIGNMENT " + " | " +  " private static StringHash stringHash = " + stringHash);

                    } else {
                        stringHash = ModernHotSpotStringHash.INSTANCE;
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 301 + " | " + "stringHash = ModernHotSpotStringHash.INSTANCE;" + " | " + "LongHashFunction.java" + " | " + " ASSIGNMENT " + " | " +  " private static StringHash stringHash = " + stringHash);

                    }
                } else {
                    stringHash = HotSpotPrior7u6StringHash.INSTANCE;
eclipse.ast.parser.InstrumentationTemplate.instrum(" line number " + " | " + 304 + " | " + "stringHash = HotSpotPrior7u6StringHash.INSTANCE;" + " | " + "LongHashFunction.java" + " | " + " ASSIGNMENT " + " | " +  " private static StringHash stringHash = " + stringHash);
